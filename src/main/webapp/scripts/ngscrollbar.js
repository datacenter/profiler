...
.controller('scrollbarController', [function() {
    ...
    var defaultConfig = {
        ...
        scrollbar: {
            ...
            hoverWidth: 12, //scrollbar width when the mouse hover on it
            color: 'rgba(250, 250, 250, 0.8)' //scrollbar background color
        },
        scrollbarContainer: {
            width: 12, //scrollbarContainer width
            color: 'rgba(250, 250, 250, 0.7)' // scrollbarContainer background
        }
    };
